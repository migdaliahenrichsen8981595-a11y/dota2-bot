    ...
    tiers.forEach(tier => {
        ...
        container.innerHTML = heroes.map(([name, data]) => `
            <div class="hero-card" onclick="showHeroDetails('${name}')">
                ${data.image ? `<img src="${data.image}" alt="${name}" class="hero-image" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                <div class="hero-icon" style="display:none;">${data.icon}</div>` : `<div class="hero-icon">${data.icon}</div>`}
    ...
    container.innerHTML = heroes.map(hero => {
        ...
        return `
            <div class="hero-card ${isSelected ? 'selected' : ''}"
                ...
                ${heroData.image ? `<img src="${heroData.image}" alt="${hero}" class="hero-image" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                <div class="hero-icon" style="display:none;">${heroData.icon}</div>` : `<div class="hero-icon">${heroData.icon}</div>`}
